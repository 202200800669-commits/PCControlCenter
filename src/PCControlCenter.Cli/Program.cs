...
if(!(args is ["probe"] || args is ["export",_] || args is ["probe","--elevated"] || args is ["export",_,"--elevated"])){Console.Error.WriteLine("参数无效，使用 --help。");return 2;}
