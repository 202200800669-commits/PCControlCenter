...
public sealed record Snapshot(string Provider, DeviceIdentity Device, IReadOnlyList<Capability> Capabilities, IReadOnlyList<Reading> Readings, IReadOnlyList<string> IssueCodes);
