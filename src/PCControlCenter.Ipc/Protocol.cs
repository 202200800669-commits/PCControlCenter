...
public static class BrokerProtocol
{
    ...
    public static bool Valid(BrokerRequest q) => q.Version == Version && Guid.TryParseExact(q.RequestId, "N", out _) && ValidIdentity(q.Device) && ((q.Operation == "read-fans" && q.Trial is null && q.Mode is null && q.Energy is null) || (q.Operation == "fan-trial" && q.Trial is { IsValid: true } && q.Mode is null && q.Energy is null) || (q.Operation == "set-mode" && q.Mode is { IsValid: true } && q.Trial is null && q.Energy is null) || (q.Operation == "set-energy" && q.Energy is { IsValid: true } && q.Trial is null && q.Mode is null));
